  ...
  if (error || !submission) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8faff', fontFamily: 'sans-serif', padding: '1.5rem', flexDirection: 'column', gap: '16px' }}>
        ...
        <a href="/seller" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>← Back to Dashboard</a>
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0f7ff 0%, #fff7f0 60%, #f0fdf4 100%)', fontFamily: "'DM Sans', sans-serif", padding: '20px 16px' }}>
      ...
      <div style={{ maxWidth: '420px', margin: '0 auto 16px' }} className="no-print">
        <a href="/seller" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#475569', textDecoration: 'none', fontWeight: 600, fontSize: '0.875rem', background: 'white', padding: '8px 14px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
      ...
      <div style={{ maxWidth: '420px', margin: '20px auto 0', display: 'flex', gap: '10px', flexWrap: 'wrap' }} className="no-print">
        ...
        <a href="/seller" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '13px', background: 'linear-gradient(135deg, #2563eb, #1d4ed8)', color: 'white', textDecoration: 'none', borderRadius: '10px', fontWeight: 700, boxShadow: '0 4px 16px rgba(37,99,235,0.3)', fontSize: '0.9rem', WebkitTapHighlightColor: 'transparent' }}>
          ← Dashboard
        </a>
      </div>
    </div>
